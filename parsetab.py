...
_lr_productions = [
  ...
  ('start_symbol -> program','start_symbol',1,'p_start_symbol','syntaxChecker.py',104),
  ('program -> PROGRAM LEFT_BR_CURLY instructions RIGHT_BR_CURLY','program',4,'p_program','syntaxChecker.py',110),
  ('program -> empty','program',1,'p_program','syntaxChecker.py',111),
  ('instructions -> instruction','instructions',1,'p_instructions','syntaxChecker.py',121),
  ('instructions -> instruction instructions','instructions',2,'p_instructions','syntaxChecker.py',122),
  ('instruction -> for_loop','instruction',1,'p_instruction','syntaxChecker.py',128),
  ('instruction -> if_statement','instruction',1,'p_instruction','syntaxChecker.py',129),
  ('instruction -> assignment','instruction',1,'p_instruction','syntaxChecker.py',130),
  ('instruction -> empty','instruction',1,'p_instruction','syntaxChecker.py',131),
  ('instruction -> var_declaration','instruction',1,'p_instruction','syntaxChecker.py',132),
  ('instruction -> print','instruction',1,'p_instruction','syntaxChecker.py',133),
  ('instruction -> input','instruction',1,'p_instruction','syntaxChecker.py',134),
  ('for_loop -> for_loop_statement LEFT_BR_CURLY instructions RIGHT_BR_CURLY','for_loop',4,'p_for_loop','syntaxChecker.py',140),
  ('for_loop_statement -> FOR LEFT_BR INT VAR EQUAL INT_NUMBER SEMICOLON VAR LESS INT_NUMBER SEMICOLON VAR EQUAL VAR PLUS number RIGHT_BR','for_loop_statement',17,'p_for_loop_statement','syntaxChecker.py',146),
  ('if_statement -> IF LEFT_BR comparisons RIGHT_BR LEFT_BR_CURLY instructions RIGHT_BR_CURLY','if_statement',7,'p_if_statement','syntaxChecker.py',152),
  ('comparisons -> comparison','comparisons',1,'p_comparisons','syntaxChecker.py',158),
  ('comparisons -> comparison conjunction comparisons','comparisons',3,'p_comparisons','syntaxChecker.py',159),
  ('comparison -> value comparator value','comparison',3,'p_comparison','syntaxChecker.py',165),
  ('comparator -> LESS','comparator',1,'p_comparator','syntaxChecker.py',171),
  ('comparator -> LESS_EQUAL','comparator',1,'p_comparator','syntaxChecker.py',172),
  ('comparator -> GREATER','comparator',1,'p_comparator','syntaxChecker.py',173),
  ('comparator -> GREATER_EQUAL','comparator',1,'p_comparator','syntaxChecker.py',174),
  ('comparator -> EQUAL_EQUAL','comparator',1,'p_comparator','syntaxChecker.py',175),
  ('comparator -> NOT_EQUAL','comparator',1,'p_comparator','syntaxChecker.py',176),
  ('operator -> PLUS','operator',1,'p_operator','syntaxChecker.py',182),
  ('operator -> MINUS','operator',1,'p_operator','syntaxChecker.py',183),
  ('operator -> MULTIPLY','operator',1,'p_operator','syntaxChecker.py',184),
  ('operator -> DIVIDE','operator',1,'p_operator','syntaxChecker.py',185),
  ('type -> INT','type',1,'p_type','syntaxChecker.py',191),
  ('type -> STRING','type',1,'p_type','syntaxChecker.py',192),
  ('type -> BOOL','type',1,'p_type','syntaxChecker.py',193),
  ('type -> FLOAT','type',1,'p_type','syntaxChecker.py',194),
  ('conjunction -> AND','conjunction',1,'p_conjunction','syntaxChecker.py',200),
  ('conjunction -> OR','conjunction',1,'p_conjunction','syntaxChecker.py',201),
  ('number -> INT_NUMBER','number',1,'p_number','syntaxChecker.py',208),
  ('number -> FLOAT_NUMBER','number',1,'p_number','syntaxChecker.py',209),
  ('bool_value -> TRUE','bool_value',1,'p_bool_value','syntaxChecker.py',215),
  ('bool_value -> FALSE','bool_value',1,'p_bool_value','syntaxChecker.py',216),
  ('value -> number','value',1,'p_value','syntaxChecker.py',222),
  ('value -> VAR','value',1,'p_value','syntaxChecker.py',223),
  ('value -> TEXT','value',1,'p_value','syntaxChecker.py',224),
  ('value -> bool_value','value',1,'p_value','syntaxChecker.py',225),
  ('value -> math_operation','value',1,'p_value','syntaxChecker.py',226),
  ('math_operation -> VAR operator VAR','math_operation',3,'p_math_operation','syntaxChecker.py',232),
  ('math_operation -> VAR operator number','math_operation',3,'p_math_operation','syntaxChecker.py',233),
  ('math_operation -> number operator VAR','math_operation',3,'p_math_operation','syntaxChecker.py',234),
  ('math_operation -> number operator number','math_operation',3,'p_math_operation','syntaxChecker.py',235),
  ('assignment -> VAR EQUAL value SEMICOLON','assignment',4,'p_assignment','syntaxChecker.py',241),
  ('assignment -> VAR EQUAL VAR SEMICOLON','assignment',4,'p_assignment','syntaxChecker.py',242),
  ('var_declaration -> type VAR SEMICOLON','var_declaration',3,'p_var_declaration','syntaxChecker.py',248),
  ('var_declaration -> type VAR EQUAL value SEMICOLON','var_declaration',5,'p_var_declaration','syntaxChecker.py',249),
  ('var_declaration -> type VAR EQUAL VAR SEMICOLON','var_declaration',5,'p_var_declaration','syntaxChecker.py',250),
  ('print -> PRINT LEFT_BR out RIGHT_BR SEMICOLON','print',5,'p_print','syntaxChecker.py',256),
  ('out -> TEXT','out',1,'p_out','syntaxChecker.py',262),
  ('out -> VAR','out',1,'p_out','syntaxChecker.py',263),
  ('out -> number','out',1,'p_out','syntaxChecker.py',264),
  ('input -> INPUT LEFT_BR VAR RIGHT_BR SEMICOLON','input',5,'p_input','syntaxChecker.py',270),
  ('empty -> <empty>','empty',0,'p_empty','syntaxChecker.py',276),
]
